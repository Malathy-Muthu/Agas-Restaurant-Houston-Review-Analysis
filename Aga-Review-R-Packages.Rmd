...
```{r}
RestReviews_Org = read.csv(file.choose(), stringsAsFactors = FALSE) # If we have tsv file 
...
```{r}
RestReviews_Corp = VCorpus(VectorSource(RestReviews_Org$review_text))  # Create a Corpus 
